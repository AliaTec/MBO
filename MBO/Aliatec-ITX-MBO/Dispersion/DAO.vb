...
Public Class DAO
    ...
    Private Const Contabilidad As String = "sp_Reporte_Contabilidad '@IdRazonSocial','@IdTipoNominaAsig','@IdTipoNominaProc','@Anio','@Periodo','@UID','@LID','@idAccion'"
    Private Const GravaExenMen As String = "sp_NomGraExeMensual '@IdRazonSocial','@IdTipoNominaAsig', '@folioDesde', '@folioHasta', '@UID', '@LID', '@idAccion'"
    Private Const Contabilidad_Mensual As String = "sp_Reporte_Contabilidad_Mensual '@IdRazonSocial','@IdTipoNominaAsig','@IdTipoNominaProc','@folioDesde','@folioHasta','@UID','@LID','@idAccion'"
    Private Const ISN As String = "sp_Reporte_ImpuestoEstatal '@IdRazonSocial','@IdTipoNominaAsig','@folioDesde','@folioHasta','@UID','@LID','@idAccion'"
    Private Const ReporteMenLM As String = "sp_ReporteMensualListadoMaestro '@IdRazonSocial','@IdTipoNominaAsig','@IdTipoNominaProc','@folioDesde','@folioHasta','@UID','@LID','@idAccion'"
    ...
    Public Function Layout(ByVal ReportesProceso As EntitiesITX.ReportesProceso, ByVal opL As String) As DataSet
        ...
        Try
            Select Case opL
                ...
                Case "GravaExenMen"
                    comandstr = GravaExenMen
                    resultado = Me.ExecuteQuery(comandstr, ds, ReportesProceso)
                    Return ds

                Case "ReporteMenLM"
                    comandstr = ReporteMenLM
                    resultado = Me.ExecuteQuery(comandstr, ds, ReportesProceso)
                    Return ds
